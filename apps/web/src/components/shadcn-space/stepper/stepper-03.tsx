// Shadcn Space "stepper-03" component, installed via the shadcn CLI from
// https://shadcnspace.com. Copyright (c) 2026 Shadcn Space. MIT License; see
// THIRD-PARTY-LICENSES at the repository root.
"use client";
